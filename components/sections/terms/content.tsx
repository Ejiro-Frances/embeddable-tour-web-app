...
export function TermsContent() {
  const [expandedSections, setExpandedSections] = useState<string[]>(["agreement"]);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                >
                  <svg className="h-5 w-5" style={{ color: "oklch(0.8 0.2 70)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">Important Legal Notice</h3>
                  <p className="opacity-80">
                    This is a legally binding agreement. These Terms govern your use of Tourify&#39;s services. 
                    By using our Service, you agree to these terms. We recommend consulting with legal counsel 
          ...
          <div className="space-y-6">
            {sections.map((section, index) => (
              ...
              >
                <div 
                  className="glass-effect rounded-2xl overflow-hidden cursor-pointer transition-all hover:border-amber-500/30"
                    ...
                    >
                      <div 
                        ...
                        style={{
                          ...
                          '--tw-prose-links': 'oklch(0.8 0.2 70)',
                        ...
                        <div className="whitespace-pre-line text-opacity-90">
                          {section.content.split('\n').map((paragraph, i) => {
                            if (paragraph.startsWith('### ')) {
                              return (
                                <h4 key={i} className="text-lg font-semibold mt-6 mb-3 text-amber-400">
                                ...
                                return (
                                  <div key={i} className="flex gap-2 mt-2">
                                    <div className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                                      style={{ background: "oklch(0.8 0.2 70)" }}
                                    />
                                    <div>
                              ...
                              return (
                                <div key={i} className="my-3 p-4 rounded-lg"
                                  style={{
                                    background: "oklch(0.1 0 0)",
                                    borderLeft: "4px solid oklch(0.8 0.2 70)"
                                  }}
                                >
          ...
          >
            ...
            >
              ...
              <p className="opacity-80 mb-6">
                By using Tourify&#39;s services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
              </p>
