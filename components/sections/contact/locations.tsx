                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm opacity-60">{location.country}</p>
                          </div>
                        </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-3">
                        ...
                        >
                          <MapPin className="h-4 w-4" style={{ color: location.color }} />
                        </div>
                        <div>
                          <p className="font-medium mb-1">Address</p>
                          <p className="text-sm opacity-70">{location.address}</p>
                          <p className="text-sm opacity-70">{location.postal}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-lg"
                            style={{ background: `${location.color}15` }}
                          >
                            <Phone className="h-4 w-4" style={{ color: location.color }} />
                          </div>
                          <div>
                            <p className="text-sm font-medium">Phone</p>
                            <p className="text-sm opacity-70">{location.phone}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-lg"
                            style={{ background: `${location.color}15` }}
                          >
                            <Mail className="h-4 w-4" style={{ color: location.color }} />
                          </div>
                          <div>
                            <p className="text-sm font-medium">Email</p>
                            <p className="text-sm opacity-70">{location.email}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-lg"
                            style={{ background: `${location.color}15` }}
                          >
                            <Clock className="h-4 w-4" style={{ color: location.color }} />
                          </div>
                          <div>
                            <p className="text-sm font-medium">Hours</p>
                            <p className="text-sm opacity-70">{location.hours}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-lg"
                            style={{ background: `${location.color}15` }}
                          >
                            <Users className="h-4 w-4" style={{ color: location.color }} />
                          </div>
                          <div>
                            <p className="text-sm font-medium">Team</p>
                            <p className="text-sm opacity-70">{location.teamSize}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10">
                      <button className="w-full py-3 rounded-lg font-medium transition-all hover:scale-105 group"
                        style={{
                          background: `${location.color}15`,
                          color: location.color
                        }}
          ...
          >
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-4">
                <Globe className="h-8 w-8" style={{ color: "oklch(0.8 0.2 70)" }} />
                <h3 className="text-2xl font-bold">Remote-First Company</h3>
              </div>
              <p className="opacity-80 mb-6 max-w-2xl mx-auto">
                We&apos;re a distributed team with members across 15+ countries. Our culture is built on async communication, flexibility, and results.
              </p>
              <div className="flex flex-wrap gap-3 justify-center">
                {["Flexible Hours", "Async Work", "Global Team", "Results-Driven"].map((item) => (
                  <Badge 
                    key={item}
                    variant="secondary"
                    className="px-4 py-2"
