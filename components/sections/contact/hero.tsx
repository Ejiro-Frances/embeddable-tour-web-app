      ...
      additionalInfo={
        <>
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-amber-500/20 to-amber-600/10 border border-amber-500/20">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-gray-300">
                Need urgent assistance? Email support@tourify.com for priority support.
              </p>
            </div>
          </motion.div>
        </>
