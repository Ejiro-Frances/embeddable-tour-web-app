      ...
      >
        {[
          ...
          <motion.a
            ...
            whileHover={{ y: -5 }}
            className="p-6 rounded-2xl text-left group bg-white/5 border border-white/10 hover:border-amber-500/30 transition-colors"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-white">{link.title}</h3>
