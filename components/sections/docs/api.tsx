...
const configurationOptions = [
  {
    ...
    properties: [
      { name: "primaryColor", type: "string", default: "#f59e0b", description: "Primary brand color" },
  ...
  },
  {
    ...
    properties: [
      { name: "autoStart", type: "boolean", default: "false", description: "Start tour automatically" },
      { name: "showProgress", type: "boolean", default: "true", description: "Show progress bar" },
      { name: "allowSkip", type: "boolean", default: "true", description: "Allow users to skip tour" },
  ...
  },
  {
    ...
    properties: [
      { name: "position", type: "string", default: "auto", description: "Tooltip position" },
      { name: "offset", type: "number", default: "10", description: "Offset from target element" },
      { name: "zIndex", type: "number", default: "9999", description: "Z-index of tour elements" },
      { name: "animationDuration", type: "number", default: "300", description: "Animation duration in ms" },
    ],
  },
];
    ...
    <section id="api-reference" className="py-24 relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <Code className="h-4 w-4" style={{ color: "oklch(0.8 0.2 70)" }} />
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="glass-effect mb-8">
              <TabsTrigger value="endpoints" className="data-[state=active]:text-black">
                API Endpoints
              </TabsTrigger>
              <TabsTrigger value="configuration" className="data-[state=active]:text-black">
                Configuration
              </TabsTrigger>
              <TabsTrigger value="events" className="data-[state=active]:text-black">
                Events
              </TabsTrigger>
            </TabsList>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {apiEndpoints.map((endpoint, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <code className="text-sm opacity-80">{endpoint.endpoint}</code>
                        </div>
                      ...
                      >
                        <Zap className="h-5 w-5" style={{ color: endpoint.color }} />
                      </div>
                    </div>
                    ...
                    >
                      <div className="text-sm opacity-70 mb-2">Example Request</div>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {config.properties.map((prop) => (
                        <div key={prop.name} className="pb-3 border-b border-white/10 last:border-0">
            ...
            <TabsContent value="events">
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <MessageSquare className="h-6 w-6" style={{ color: "oklch(0.8 0.2 70)" }} />
                  <h3 className="text-2xl font-bold">Event System</h3>
                </div>
                
                <p className="opacity-80 mb-8">
                  Tourify provides a comprehensive event system for tracking user interactions
                  and customizing tour behavior.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={event.event} className="p-4 rounded-lg"
                      style={{ background: "oklch(0.05 0 0 / 0.5)" }}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <code className="font-bold text-amber-400">{event.event}</code>
